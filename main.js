...
document.getElementById("user_draw").innerHTML = "The Doodle You Have To Draw => " + Element_of_array;
...
function updateCanvas() {
    ...
    Element_of_array = quick_draw_data_set[random_no];
    sketch = Element_of_array;  
    document.getElementById("user_draw").innerHTML = "The Doodle You Have To Draw => " + sketch;
}
